...
export const services4 = [
  {
    ...
    imageSrc: '/assets/images/oneness/RES-REFURB-1.png',
    alt: 'Residential Refurbishment',
    align: 'text-start',
  },
  {
    title: 'Office Reolocation',
    imageSrc: '/assets/images/oneness/OFFICE-RELOCATE-1.png',
    alt: 'Office Relocation',
    align: 'text-end',
  },
  {
    title: 'Pop-up Store',
    imageSrc: '/assets/images/oneness/POP-UP-STORE-1.png',
    alt: 'Pop-up Store',
    align: 'text-start',
  },
  {
